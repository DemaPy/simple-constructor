		...
		<tr>
            ...
            <tr>
                <td class="newsletterTopBottomContainer" align="left">
                    <span class="newsletterConditions">*Bedingungen: ${text}</span>
                </td>
            </tr>
            <tr>
                <td
  ...
  CHDE: (
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" class="newsletterFooter" style="max-width:650px; background-color:#ffffff; display: block;">
        <tbody>
            ...
            <tr>
                <td align="left" class="newsletterTopBottomContainer"><span class="newsletterConditions">*Bedingungen: ${text}</span></td>
            </tr>
            <tr>
    ...
    <tbody>
       ...
       <tr>
        ...
        <tr>
            <td
                style="vertical-align: middle; text-align: center; font-size: 14px; font-family: 'Open Sans', sans-serif!important; color: #000000;">
                <p><a href="file:///C|/Users/User/Desktop/NEW Footer/Nowy folder/[[newsunassignurl]]" style="text-decoration: underline; color: #000000;">Désabonnement</a>
                </p>
            </td>
        </tr>
    ...
    <table style="max-width:650px; background-color:#ffffff; display: block;" class="newsletterFooter" cellspacing="0" cellpadding="0"
     ...
     <tbody>
		...
		<tr>
         ...
         <tr>
             <td class="newsletterTopBottomContainer" align="left">
                 <span class="newsletterConditions">*Termini e Condizioni: ${text}</span>
             </td>
         </tr>
         <tr>
             <td
                ...
                <td align="center" class="newsletterFooterCompanyDetails">
                    <span style="color: #000000;text-align: center; font-size:11px;">
                        ...
                        Numero di telefono: 06 5654 8602; Indirizzo e-mail: <a
                            ...
                            egistro commerciale (USt-IDNr): registro commerciale del Canton ZUG, CHE-115.695.894<br />Partita IVA: DE 276156472
                    </span>
                </td>
            </tr>
        </tbody>
            ...
            <tr>
                <td align="center" class="newsletterFooterCompanyDetails">
                    <span style="color: #000000;text-align: center; font-size:11px;">
                        ...
                        teléfono: 911 983 442; dirección e-mail: <a
                            href="mailto:mail@beliani.es">mail@beliani.es</a><br />
                        HRegistro comercial: Registro comercial de cantón ZUG, CHE-115.695.894<br />
                        USt-IDNr: DE 276156472
                    </span>
                </td>
            </tr>
    ...
    <table style="max-width:650px; background-color:#ffffff; display: block;" class="newsletterFooter" cellspacing="0" cellpadding="0"
      ...
      <tbody>
         ...
         <tr>
          ...
          <tr>
              <td class="newsletterTopBottomContainer" align="left">
                  <span class="newsletterConditions">*Warunki: ${text}</span>
              </td>
          </tr>
          <tr>
              <td
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="newsletterFooter" style="max-width:650px; background-color:#ffffff; display: block;">
	<tbody>
		...
		<tr>
			<td align="left" class="newsletterTopBottomContainer"><span class="newsletterConditions">*Feltételek: ${text}</span></td>
		</tr>
		<tr>
			<td style="vertical-align: middle; text-align: center; font-size: 14px; font-family: 'Open Sans', sans-serif!important; color: #000000;">
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="newsletterFooter" style="max-width:650px; background-color:#ffffff; display: block;">
  ...
  SE: (
    ...
    <tbody>
        ...
        <tr>
            <td class="newsletterTopBottomContainer" align="left">
                <span class="newsletterConditions">*Villkor: ${text}</span>
            </td>
        </tr>
        <tr>
            <td
                ...
                <td align="center" class="newsletterFooterCompanyDetails">
                    <span style="color: #000000;text-align: center; font-size:11px;">
                        ...
                        Phone: 08-446 891 58; E-mail address: <a
                            href="mail@beliani.se">mail@beliani.se</a><br />
  ...
  CZ: (
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" class="newsletterFooter" style="max-width:650px; background-color:#ffffff; display: block;">
        <tbody>
            ...
            <tr>
                <td align="left" class="newsletterTopBottomContainer"><span class="newsletterConditions">*Podmínky: ${text}</span></td>
            </tr>
            <tr>
                <td style="vertical-align: middle; text-align: center; font-size: 14px; font-family: 'Open Sans', sans-serif!important; color: #000000;">
                ...
                <td align="center" class="newsletterFooterCompanyDetails">
                    <span style="color: #000000;text-align: center; font-size:11px;">
                        ...
                        Puhelinnumero: 09 4245 0464; sähköpostiosoite: <a
                            href="mail@beliani.se">mail@beliani.fi</a><br />
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="newsletterFooter" style="max-width:650px; background-color:#ffffff; display: block;">
	<tbody>
		...
		<tr>
			<td align="left" class="newsletterTopBottomContainer"><span class="newsletterConditions">*Podmienky: ${text}</span></td>
		</tr>
		<tr>
			<td style="vertical-align: middle; text-align: center; font-size: 14px; font-family: 'Open Sans', sans-serif!important; color: #000000;">
